...
class SensorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sensor" do
    assert_difference('Sensor.count') do
      post sensors_url, params: { sensor: { RAILS_ENV=development: @sensor.RAILS_ENV=development } }
    end
  ...
  test "should update sensor" do
    patch sensor_url(@sensor), params: { sensor: { RAILS_ENV=development: @sensor.RAILS_ENV=development } }
